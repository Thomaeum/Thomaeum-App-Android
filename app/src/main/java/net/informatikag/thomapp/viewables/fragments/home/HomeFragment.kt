...
class HomeFragment : Fragment(), ArticleClickHandler{
    ...
    private val substitutionViewModel:SubstitutionViewModel by activityViewModels()   // Viewmodel für den Vertretunsplan
    ...
    override fun onCreateView(
        ...
        // Substitution
        substitutionViewModel.initListView(binding.homeSubstitutionPreview, binding.homeSubstitutionEmptyText, requireContext(), viewLifecycleOwner, requireActivity(), 0, false)
